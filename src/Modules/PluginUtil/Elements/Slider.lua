...
return function(pluginUtil, i: number, elemData: Types.Property<number>)
    ...
    if not elemData.Maximum then elemData.Maximum = 1 end;
    if not elemData.Minimum then elemData.Minimum = -1 end;
    local val;
                ...
                [ Children ] = {
                    ...
                    New "Frame" {
                        ...
                        Position = Computed(function()
                            return UDim2.new((val:get() - elemData.Minimum) / (elemData.Maximum - elemData.Minimum), 0, 0.5, 0);
                        end),
                        [ Children ] = {
                            New "UICorner" {
                                CornerRadius = UDim.new(1, 0)
